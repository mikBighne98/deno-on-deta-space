          ...
          >
            ...
            >
              <path
                ...
                d="M14.666 8A6.667 6.667 0 0 1 8 14.666 6.667 6.667 0 0 1 1.333 8a6.667 6.667 0 0 1 13.333 0z"
              />
              <path
                fill="#bd399c"
                vector-effect="non-scaling-stroke"
                d="M13.334 8A5.333 5.333 0 0 1 8 13.334 5.333 5.333 0 0 1 2.667 8a5.333 5.333 0 0 1 10.667 0z"
              />
              <path
                fill="#93388e"
                vector-effect="non-scaling-stroke"
                d="M12 8a4 4 0 0 1-4 4 4 4 0 0 1-4-4 4 4 0 0 1 8 0z"
              />
              <path
                fill="#563379"
                vector-effect="non-scaling-stroke"
                d="M10.666 8A2.667 2.667 0 0 1 8 10.666 2.667 2.667 0 0 1 5.333 8a2.667 2.667 0 0 1 5.333 0z"
              />
            </svg>
          </a>
          <a
